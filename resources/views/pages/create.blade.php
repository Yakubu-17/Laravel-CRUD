...
@section('content')
 ...
 {{csrf_field()}}
    <div class="form-group">
        ...
        {{ Form::textarea('products_name', '',['placeholder' => 'Product Name', 'class' => 'form-control']) }}
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        {{ Form::text('products_description', '',['placeholder' => 'Product Description', 'class' => 'form-control']) }}
